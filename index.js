...
app.post("/webhooks", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    switch (eventID) {
        case "chat:start":
            ...
            const result = yield axios_1.default.post("https://restapi.bitrix24.com/rest/1/31uhq2q855fk1foj/crm.lead.add.json", body);
            res.send(result);
            break;
        case "chat:end":
            res.send("chat end");
